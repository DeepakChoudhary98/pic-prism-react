...
const Navbar = () => {
  return (
    <>
        <nav className='flex flex-col sm:flex-row justify-between items-start sm:items-center px-5 py-5 fixed top-0 left-0 right-0 bg-white shadow-md gap-1 sm:gap-0 z-30 '>
        {/* logo and site name */}
